  ...
  useEffect(() => {
    class WavesCanvas {
      ...
      animate() {
        ...
        gradient.addColorStop(0, 'rgba(31, 90, 128, 0.95)'); // subtle edge start // slightly lighter edge start // softened edge start
        gradient.addColorStop(0.5, 'rgba(100, 160, 200, 0.3)'); // lighter middle tint // lowered opacity for subtler hover color // Darker blue at hover area
        gradient.addColorStop(1, 'rgba(31, 90, 128, 0.95)'); // subtle edge end // slightly lighter edge end // softened edge end
