...
const SineWaveBanner = () => {
    ...
    class WavesCanvas {
      constructor(elm, options = {}) {
        ...
        this.settings = {
          ...
          baseSpeed: parseFloat(data.baseSpeed) || options.baseSpeed || 0.008, // Increased speed slightly
      ...
      Wave = class {
        ...
        updateOffset() {
          ...
          this.yOffset = centerOffset + this.index * this.settings.waveSpacing + 20; // Moves waves slightly down
        }
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "320px", overflow: "hidden" }}> {/* Increased height slightly */}
