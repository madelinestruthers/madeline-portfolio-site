...
const SineWaveBanner = () => {
  ...
  useEffect(() => {
    class WavesCanvas {
      constructor(elm, options = {}) {
        ...
        this.settings = {
          waveCount: parseInt(data.waveCount) || options.waveCount || 12,
          ...
          lineWidth: parseInt(data.lineWidth) || options.lineWidth || 1.5,
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "500px", overflow: "hidden", backgroundColor: "#1F5A80" }}> {/* Increased height */}
