    ...
    class WavesCanvas {
      constructor(elm, options = {}) {
        ...
        this.settings = {
          ...
          baseSpeed: parseFloat(data.baseSpeed) || options.baseSpeed || 0.085,
      ...
      Wave = class {
        ...
        updateOffset() {
          ...
          this.yOffset = centerOffset + this.index * this.settings.waveSpacing + 40; // Moved waves slightly down
        }
