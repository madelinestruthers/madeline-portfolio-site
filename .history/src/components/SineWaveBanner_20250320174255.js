  ...
  useEffect(() => {
    class WavesCanvas {
      ...
      animate() {
        ...
        gradient.addColorStop(0, 'rgba(31, 90, 128, 0.85)'); // slightly lighter edge start // softened edge start
        gradient.addColorStop(0.5, 'rgba(28, 76, 108, 0.4)'); // lowered opacity for subtler hover color // Darker blue at hover area
        gradient.addColorStop(1, 'rgba(31, 90, 128, 0.85)'); // slightly lighter edge end // softened edge end
