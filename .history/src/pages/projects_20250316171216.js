...
export default function Projects() {
  ...
  const projects = [
    ...
    { title: "Photoshop Painting", image: "/images/project-card-opal.jpg", link: "/projects/photoshop-painting", category: "Graphic Design" },
    ...
    { title: "How to Ground Yourself – Motion Graphics Video", image: "/images/project-card-mechanical.jpg", link: "/projects/mechanical-object", category: "Motion/Videos" },
  ];

  const categories = ["All", "Graphic Design", "UX/UI Design", "Motion/Video", "Case Study", "Technical Assignments"];
