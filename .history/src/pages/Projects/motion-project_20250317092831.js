            ...
            <main className={styles.container}>
                ...
                <div className={styles.videoDescriptionWrapper}>
                    ...
                    <div className={styles.descriptionContainer}>
                        ...
                        This motion graphics piece explores mindfulness and grounding through fluid animation, soft colors, and soothing music. Created with After Effects and Illustrator, it delivers a calm, immersive experience.
                        </p>
                    </div>
