  ...
  return (
    ...
    <Image src="/images/survey-image.png" alt="Research Image" width={800} height={360} className={styles.surveyImage}/>
          ...
          <section className={styles.designProcess}>
            ...
            <Image src="/images/home-draft.png" alt="Design Sketches" width={270} height={550} className={styles.designImage}/>
            </div>
         </section>
...
In response, new logo concepts were developed to better align with the brand’s identity while ensuring clear and effective visual communication with the target audience.
            ...
            <Image src="/images/original-logo.png" alt="Final Logo" width={250} height={250} />
          </section>
        </main>
      </div>
      <Footer />
