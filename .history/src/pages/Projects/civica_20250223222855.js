            ...
            <div className={styles.bioContainer}>
              ...
              <div className={styles.problemSolution}>
                <div className={styles.problemBox}>
                  <h3>Problem</h3>
                  <p>
                    Many underprivileged women face legal barriers due to lack of access to information, financial constraints, and fear of legal proceedings. They struggle to understand their rights and navigate the complex legal system.
                  </p>
                </div>
                <div className={styles.solutionBox}>
                  <h3>Solution</h3>
                  <p>
                    Civica provides a user-friendly legal aid app with multilingual chatbot support, simplified legal documents, and access to legal, mental health, and counseling resources, empowering women with the tools they need.
                  </p>
                </div>
              </div>
