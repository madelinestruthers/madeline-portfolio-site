      ...
      <div className={styles.page}>
        <main className={styles.container}>
          ...
          <div className={styles.imageGrid}>
            ...
            <div className={styles.imageRow}>
              <Image src="/images/viper-honeydew-front.png" alt="honeydew flavour viper energy drink" width={200} height={200} />
              <Image src="/images/viper-honeydew.png" alt="honeydew flavour viper energy drink" width={100} height={200} />
            </div>
          </div>
        </main>
      </div>
