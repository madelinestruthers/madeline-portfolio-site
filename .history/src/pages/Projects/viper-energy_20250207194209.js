        ...
        <main className={styles.container}>
          ...
          <div className={styles.imageGrid}>
            <div className={styles.imageRow}>
              <Image src="/images/drink1.png" alt="Drink 1" width={200} height={200} />
              <Image src="/images/can1.png" alt="Can 1" width={100} height={200} />
            </div>

            <div className={styles.imageRow}>
              <Image src="/images/drink2.png" alt="Drink 2" width={200} height={200} />
              <Image src="/images/can2.png" alt="Can 2" width={100} height={200} />
            </div>

            <div className={styles.imageRow}>
              <Image src="/images/drink3.png" alt="Drink 3" width={200} height={200} />
              <Image src="/images/can3.png" alt="Can 3" width={100} height={200} />
            </div>
          </div>
        </main>
      </div>
