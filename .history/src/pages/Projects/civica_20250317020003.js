        ...
        <main className={styles.container}>
          ...
          <section>
            <div>
              ...
              <h3>Business Card</h3>
              <br />
              <Image src="/images/business-card.png" alt=" Civica Blog " width={200} height={400} className={styles.wireframes} />
              <Image src="/images/card-front.png" alt=" Civica Blog " width={650} height={500} className={styles.wireframes} />
            </div>
