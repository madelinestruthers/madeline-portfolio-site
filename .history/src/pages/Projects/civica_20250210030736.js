...
export default function Civica() {
  return (
    ...
    <Image src="/images/survey-image.png" alt="Research Image" width={730} height={340} className={styles.surveyImage}/>
</section>

          {/* The Design Process */}
          <section className={styles.designProcess}>
            <h2 className={styles.h2}>The Design Process</h2>
            <Image src="/images/design-sketch.png" alt="Design Sketches" width={600} height={400} className={styles.designImage}/>
          </section>
