        ...
        <div className={styles.videoDescriptionWrapper}>
          ...
          <div className={styles.insightsGrid}>
            <div className={styles.imageGroup}>
              <img src="/images/new-post-1.png" alt="New post insight 1" />
              <img src="/images/new-post-2.png" alt="New post insight 2" />
            </div>
            <div className={styles.imageGroup}>
              <img src="/images/old-post-1.png" alt="Old post insight 1" />
              <img src="/images/old-post-2.png" alt="Old post insight 2" />
            </div>
          </div>
