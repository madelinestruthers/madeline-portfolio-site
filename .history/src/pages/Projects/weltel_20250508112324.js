    ...
    return (
        <div className={styles.page}> {/* ✅ Add a wrapper div */}
            ...
            <main className={styles.container}>
                <h1 className={styles.h1Style}>Social Media Graphics for <br/>Weltel Health</h1>
                ...
                <div className={styles.assetContainer}>
                    <div className={styles.assets}>
                        ...
                        <Image src="/images/heart_asset.png" alt="Asset 3" width={150} height={150} className={styles.assetImage} />
                        <Image src="/images/red_cross_asset.png" alt="Asset 1" width={3000} height={250} className={styles.assetImage} />
