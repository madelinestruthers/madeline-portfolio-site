          ...
          <section className={styles.researchSection}>
            ...
            <div className={styles.researchContent}>
              <div>
                ...
                <p className={styles.lawyerBio}>
                  A lawyer provided seven real case studies of women in vulnerable situations, highlighting key challenges such as workplace exploitation, harassment, legal vulnerabilities, and mental health impacts.
                </p>
                <h3>Key Findings</h3>
                <ul>
                  <li>Workplace Exploitation – <br />Blurred boundaries, excessive workload, and power imbalances.</li>
                  <li>Harassment & Abuse – <br />Verbal, emotional, and psychological mistreatment.</li>
                  <li>Legal Vulnerability – <br />Fear of speaking out due to lack of legal awareness.</li>
                  <li>Mental Health Impact – <br />Stress, anxiety, and hospitalization in severe cases.</li>
                </ul>
              </div>
            </div>
            ...
            <div className={styles.surveySection}>
              ...
              <p className={styles.surveyBio}>
                Surveys and usability testing were conducted to gather user feedback and identify pain points. Surveys provided insights into user perceptions, while usability testing evaluated how effectively users interacted with the design. Findings informed iterative improvements, ensuring a more intuitive and user-centered experience.
              </p>
          ...
          <section className={styles.logoSection}>
            ...
            <div className={styles.researchContent}>
              ...
              <div className={styles.researchImages}>
                <Image src="/images/original-logo.png" alt="Original Logo" width={350} height={340} />
              </div>
            </div>
          </section>
