  ...
  return (
    ...
    <ul>
        ...
        <div className={styles.researchImages}>
            <Image src="/images/law-image.jpg" alt="Research Image" width={530} height={350} />
        </div>
    </div>
    
</section>
<h3>User Surveys</h3>
    <p className={styles.lawyerBio}>Surveys and usability testing were conducted to gather user feedback and identify pain points. Surveys provided insights into user perceptions, while usability testing evaluated how effectively users interacted with the design. Findings informed iterative improvements, ensuring a more intuitive and user-centred experience.
    </p>
