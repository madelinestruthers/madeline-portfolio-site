      ...
      <div className={styles.page}>
        <main className={styles.container}>
          ...
          <section className={styles.researchSection}>
            ...
            <p>A lawyer provided seven real case studies of women in vulnerable situations, highlighting key challenges such as workplace exploitation, harassment, legal vulnerabilities, and mental health impacts.</p>
