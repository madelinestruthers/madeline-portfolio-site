        ...
        <main className={styles.container}>
          ...
          <section className={styles.heroSection}>
            <div className={styles.bioContainer}>
              ...
              <h2 className={styles.link}> <a href="https://www.figma.com/proto/0NxjFtht1BziwLShVjdx5B/Civica-2.0?content-scaling=fixed&kind=proto&node-id=30-1676&scaling=scale-down&starting-point-node-id=30%3A1600&t=g9MmfxrmwiapgGrs-1
