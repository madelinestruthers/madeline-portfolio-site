...
export default function Civica() {
  return (
    ...
    <Image src="/images/survey-image.png" alt="Research Image" width={800} height={350} className={styles.surveyImage}/>
</section>

          {/* The Design Process */}
          <section className={styles.designProcess}>
            <h2 className={styles.h2}>The Design Process</h2>
            <Image src="/images/design-sketch.png" alt="Design Sketches" width={900} height={600} className={styles.designImage}/>
          </section>
