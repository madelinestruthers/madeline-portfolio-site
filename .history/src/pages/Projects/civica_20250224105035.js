    ...
    <>
      ...
      <div className={styles.page}>
        <main className={styles.container}>
          ...
          <div className={styles.finalLogoContainer}>
              <Image src="/images/original-wireframes.png" alt=" Civica Logo " width={900} height={350} />
            </div>
            <h3>Redesign</h3>
            <div className={styles.finalLogoContainer}>
            <Image src="/images/second-iteration.png" alt=" Civica Logo " width={900} height={350} />
            </div>
            <h3>Final Design</h3>
            <div className={styles.finalLogoContainer}>
            <Image src="/images/final-version.png" alt=" Civica Logo " width={900} height={350} />
            </div>
            </div>
