        ...
        <h1 className={styles.h1Style}>Motion Graphics Showcase</h1>
          ...
          <div className={styles.videoContainer}>
            <video controls className={styles.video}>
              <source src="public/videos/motion-graphics-video.mp4" type="video/mp4" />
          ...
          <div className={styles.assetsContainer}>
            ...
            <div className={styles.assets}>
              <img src="/images/asset1.jpg" alt="Asset 1" className={styles.assetImage} />
              <img src="/images/asset2.jpg" alt="Asset 2" className={styles.assetImage} />
            </div>
          </div>
