...
import styles from "@/styles/Sqwell.module.css";
...
export default function Sqwell() {
  return (
        ...
        <main className={styles.container}>
          ...
          <section className={styles.heroSection}>
            <div className={styles.bioContainer}>
              ...
              <h2 className={styles.link}> <a href="https://sqwell.vercel.app/">sqwell.vercel.app</a></h2>
            </div>
    ...
    <div className={styles.researchContent}>
        <div>
        <h2 className={styles.link}> <a href="https://sqwell-styleguide.vercel.app/">Coded Styleguide</a></h2>
            ...
            <h3 classname={styles.spacing}>Colour Palette</h3>
...
<br/>
    ...
    <h3 className={styles.spacing}>Original Logo vs Revised Version</h3>
    ...
    <h3 classname={styles.spacing}>Key Findings</h3>
...
<br/>
    <h3 classname={styles.spacing}>Original Badge Library Icon vs Revised Version</h3>
        ...
        <Image src="/images/revised-profile.png" alt=" Logo Draft" width={300} height={360} />
          ...
          <section>
          <h1 className={styles.h1Style}>Figma Wireframes</h1>
          <br/><br/>
