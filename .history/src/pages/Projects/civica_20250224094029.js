...
export default function Civica() {
 ...
 <Image src="/images/research.png" alt="Research Image" width={680} height={300} className={styles.researchImages} />
          ...
          <div className={styles.surveySection}>
              ...
              <Image src="/images/persona-1.png" alt="Research Image" width={600} height={900} className={styles.logoImages} />
              <Image src="/images/persona-2.png" alt="Research Image" width={600} height={900} className={styles.logoImages} />
            </div>
