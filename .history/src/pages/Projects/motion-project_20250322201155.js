                ...
                <div className={styles.videoDescriptionWrapper}>
                    ...
                    <div className={styles.descriptionContainer}>
                        <p className={styles.description}>
                            Made for kids, this motion graphics piece explores mindfulness and grounding through fluid animation, soft colors, and soothing music. Created with <strong>After Effects</strong> and <strong>Illustrator</strong>, it delivers a calm, immersive experience.
                        </p>
                    </div>
