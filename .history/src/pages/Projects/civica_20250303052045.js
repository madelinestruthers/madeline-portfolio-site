        ...
        <main className={styles.container}>
          ...
          <section className={styles.heroSection}>
            <div className={styles.bioContainer}>
              ...
              <h2 className={styles.link}> <a href="https://www.civicalaw.ca/">Civica Website</a></h2>
...
<br/>
          ...
          <h3>Civica Blog</h3>
          <p>The blog made with Next.js for Civica featured weekly updates on the project's progress and challenges, highlighting achievements and sharing insights into the development process.</p>
          <Image src="/images/final-version.png" alt=" Civica Blog " width={900} height={350} className={styles.wireframes} />
          <h2 className={styles.link}> <a href="https://www.civicalaw.ca/blog">Civica Website</a></h2>
          </div>
          <h3>Social Media</h3>
            <h3>Brochure</h3>
            <h3>Business Card</h3>
