...
In response, new logo concepts were developed to better align with the brand’s identity while ensuring clear and effective visual communication with the target audience.
        ...
        <Image src="/images/logo-draft-1.png" alt=" Logo Draft" width={300} height={300} />
        <Image src="/images/logo-draft-2.png" alt=" Logo Draft" width={300} height={300} />
        <Image src="/images/logo-draft-3.png" alt=" Logo Draft" width={300} height={300} />
        <Image src="/images/logo-draft-4.png" alt=" Logo Draft" width={300} height={300} />
        </div>
        <h3>Final Logo</h3>
        <p className={styles.logoBio}>
        ...
        <Image src="/images/final-logo-2.png" alt=" Civica Logo " width={00} height={300} />
        </div>
          </section>
          <section>
