      ...
      <div className={`${styles.page}`}>
        <main className={styles.container}>
          <div className={styles.bioContainer}>
            ...
            <br/><br/>
I graduated with distinction from BCIT’s Digital Design & Development program, where I juggled nine courses at once (time management leveled up). I also completed a design internship at WelTel Health, where I boosted Instagram reach by 1400%, helped develop a visual style guide, and designed Figma wireframes to improve UX. I love bringing ideas to life through graphic design, marketing content, and UX, with skills in Adobe Creative Suite, Figma, and Canva.
<br/><br/>
